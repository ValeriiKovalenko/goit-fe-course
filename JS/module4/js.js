...
// // Создайте двухмерный массив. Первые два ключа - это 'ru' и 'en'. Пусть первый ключ содержит элемент, являющийся массивом названий дней 
// // недели по-русски, а второй - по-английски. Выведите с помощью этого массива понедельник по-русски
// //  и среду по английски (пусть понедельник - это нулевой день)9
...
//   console.log(
//     countProps({a: 1, b: 3, c: 'hello', s: 5})
//   ); // 3
...
//     }
// }
// const Margo = new cashier('margo');
// Margo.plus('iron');
// Margo.plus('iron')
// console.log(Margo)

// const Gena = new cashier('gena', 1)
// Gena.plus('iron', 'tea')
// Gena.plus('iron', 'tea')
// Gena.plus('iron', 'tea')
// Gena.plus('iron', 'tea')
...
*/
 ...
 function Cashier(products, money) {
